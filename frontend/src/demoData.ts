...
export const previewCase: CaseRecord = {
  ...
  decision: {
    ...
    v5_action: 'ALLOW',
    action: 'VERIFY',
    routing_reason: 'MENTALIST_PROACTIVE',
    policy_version: 'mentalist_v1.0_runtime',
  },
  mentalist: {
    score: .82,
  ...
  case_file: {
    ...
    action_changed: true,
    routing_reason: 'MENTALIST_PROACTIVE',
    explanation: 'Corroborating present-tense behavioral evidence formed a stronger investigation case; no confirmed-fraud relationship was required by Mentalist.',
